...
<nav class="navbar navbar-expand-lg mb-4 top-bar navbar-static-top sps sps--abv">
    <div class="container">
        ...
        <a class="navbar-brand mx-auto" href="{{ url("home") }}">BETTER <span>LIVING</span></a>
...
<div class="swiper-container main-slider" id="myCarousel">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide slider-bg-position" style="background:url('https://s-media-cache-ak0.pinimg.com/originals/da/2e/b4/da2eb46a8dcedd9a1153636e8bac150d.jpg')" data-hash="slide1">
            ...
            {{--<h2>Homes with a difference make the choice now </h2>--}}
        </div>
        <div class="swiper-slide slider-bg-position" style="background:url('https://www.pinterest.co.uk/pin/534098837042156944/')" data-hash="slide2">
